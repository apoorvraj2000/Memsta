...
// Instantiate the RequestQueue.
        //RequestQueue queue = Volley.newRequestQueue(this); We are using SingleTon class
        ...
        JsonObjectRequest jsonObjectRequest = new JsonObjectRequest
                (Request.Method.GET, url, null, new Response.Listener<JSONObject>() {
                    ...
                    public void onResponse(JSONObject response) {
                        ...
                        try {
                            ImageView img=(ImageView) findViewById(R.id.memeView);
                            currentImgUrl=response.getString("url");

                            Glide.with(Memes.this).load(currentImgUrl).listener(new RequestListener<Drawable>() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        Toast.makeText(Memes.this,"Something is wrong" , Toast.LENGTH_LONG).show();
                    }
                });
...
// Add the request to the RequestQueue.
    ...
    public void shareMeme(View view) {
        ...
        String msg="Hey check out this meme I got from "+ currentImgUrl;
